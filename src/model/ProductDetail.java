...
public class ProductDetail {
	...
	private String 	pr_PD_Image;
	private String	pr_Status;

	public ProductDetail(String pr_ID, String pr_CA_ID, String pr_Name, float pr_Price, int pr_Quantify,
			String pr_SU_ID, String pr_PD_Image, String pr_Status) {
		super();
		this.pr_ID = pr_ID;
	...
	public String getPr_PD_Image() {
		return pr_PD_Image;
	}

	public void setPr_PD_Image(String pr_PD_Image) {
		this.pr_PD_Image = pr_PD_Image;
	}
